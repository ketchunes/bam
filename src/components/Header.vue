        ...
        <a href="">
          <div>
            <div class="flex items-center gap-2">
              ...
              <div class="hover:text-red-400 transition">Корзина</div>
            </div>
          </div>
        </a>
        <a href="">
          <div>
            <div class="flex items-center gap-2">
              <svg class="mt-1" xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 19 17" fill="none">
              ...
              <div class="hover:text-red-400 transition">Закладки</div>
            </div>
          </div>
        </a>
        <a href="">
          <div>
            <div class="flex items-center gap-2">
              ...
              <div class="hover:text-red-400 transition">Профиль</div>
            </div>
          </div>
        </a>
      </div>
